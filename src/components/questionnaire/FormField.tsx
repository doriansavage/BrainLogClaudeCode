    ...
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        <button
          ...
          style={{
            color: helpOpen ? '#D97706' : 'var(--gray-300, #D1D5DB)',
            backgroundColor: helpOpen ? '#FFFBEB' : 'transparent',
          }}
          onMouseEnter={(e) => { if (!helpOpen) e.currentTarget.style.color = '#D97706' }}
          onMouseLeave={(e) => { if (!helpOpen) e.currentTarget.style.color = 'var(--gray-300, #D1D5DB)' }}
        >
      ...
      {/* Panneau d'aide — visible quand helpOpen */}
      {helpOpen && (
        <div
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {comment && (
              <p className="text-xs" style={{ color: '#A16207' }}>
                ✓ Note sauvegardée automatiquement
              </p>
            )}
          </div>
